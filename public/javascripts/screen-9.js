...
var animations = {
  permission: function animate_permission(index) {
    var prompt = "Viewing Dimensions 73x23:";

    if(index == 0) {
      $("#cmd-line").append("<span id='access' style='color: #FF99FF;'>"); 
